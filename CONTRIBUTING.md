...
# Change directory to the jupyter_dag directory
...
jupyter server extension disable jupyter_dag
...
folder is located. Then you can remove the symlink named `@telamonian/jupyter-dag` within that folder.
...
```sh
pytest -vv -r ap --cov jupyter_dag
```
